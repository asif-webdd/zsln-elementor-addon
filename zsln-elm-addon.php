...
final class Zsln_Elemetor_Addon {
	...
	public function init() {
		...
		add_action( 'zsln-elm-addon/frontend/after_enqueue_styles', [ $this, 'zsln_widget_css' ] );

		// ZSLN Register Widget Scripts
		add_action( 'zsln-elm-addon/frontend/after_enqueue_scripts', [ $this, 'zsln_widget_js' ] );
